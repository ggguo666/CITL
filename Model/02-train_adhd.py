...
from imports.cnn_Dataset import ADHD_ASD_Dataset_official
...
import numpy as np
# 定义保存模型的文件夹路径
checkpoint_dir = "/home/caorui/g/my_model/251/guo/ADHD_ABIDEBaseModel/"
# 创建一个文件夹用于保存模型
...
def main():
    ...
    path = "/home/caorui/g/data/adhd200_116/dfc_cnn/ABIDEI_ADHD"
    path1 = "/home/caorui/g/data/abide_116/dfc"
    path2 = "/home/caorui/g/data/adhd200_116/dfc_cnn/dfc"
    ...
    for fold in range(0, fold):
        # 加载数据集示例
        dataset = ADHD_ASD_Dataset_official(path1, path2, save_dir=path)
        print(dataset)
    ...
    #######################################################################################
        ...
        # 定义保存模型的文件夹路径
        checkpoint_dir = "/home/caorui/g/my_model/251/guo/ADHD_ABIDEBaseModel/"
        best_model_dir = "/home/caorui/g/my_model/251/guo/ADHD_ABIDEBset_BaseModel/"
        best_model_path = ""
        test_accuracy1 = 0
        test_ave = 0
