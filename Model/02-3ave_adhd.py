...
def compute_average_feature(folder_path):
    ...
    for d1 in dirs:
        ...
        output_dir1 = os.path.join('/home/user/data/gsj/ADHD/116/adhd200_116/dfc/abide2-adhdave', d1)
        os.makedirs(output_dir1, exist_ok=True)  # 确保文件夹存在


        len_path = os.path.join("/home/user/data/gsj/ADHD/116/adhd200_116/dfc/",d1)
...
def main():
    # 假设保存特征文件的文件夹路径
    folder_path = '/home/user/data/gsj/ADHD/116/adhd200_116/dfc/abide2-adhd67afterstage2'
