...
from imports.cnn_Dataset import stage2_ADHD_Dataset_official, ADHD_ALL_Dataset_official
...
def main():
        ...
        with torch.no_grad():
            for datas in loader:
                ...
                if pred == 0:
                    ...
                    folder_path1 = os.path.join('/home/user/data/gsj/ADHD/116/adhd200_116/dfc/abide2-adhd67afterstage2',
                                                prefix, '0')
                    ...
                    suffix = i  # 假设你的数据中有一个名为 suffix 的字段来表示后缀
                    folder_path2 = os.path.join('/home/user/data/gsj/ADHD/116/adhd200_116/dfc/abide2-adhd67afterstage2',
                                                prefix, '1')
    ...
    target_root = '/home/user/data/gsj/ADHD/116/adhd200_116/dfc'
