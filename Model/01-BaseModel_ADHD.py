...
from imports.cnn_Dataset import ADHD_ALL_Dataset_official
...
import numpy as np
# 定义保存模型的文件夹路径
checkpoint_dir = "/home/user/data/gsj/111111111/my_cnn_model/BaseModel_ADHD/"
# 创建一个文件夹用于保存模型
...
def main():
    ...
    parser.add_argument('--dataroot', type=str, default='/home/user/data/gsj/ADHD/116/adhd200_116/dfc', help='root directory of the dataset')
    ...
    fold = opt.fold
    data_folder = "/home/user/data/gsj/ADHD/116/adhd200_116/dfc/cpac/filt_noglobal/raw"
    ################## Define Dataloader ##################################
    ...
    for fold in range(0, fold):
        # 加载数据集示例
        dataset = ADHD_ALL_Dataset_official(path, save_dir=path)
        print(dataset)
        tr_index, val_index, te_index = train_val_test_split(data_folder)
    ...
    #######################################################################################
        ...
        # 定义保存模型的文件夹路径
        checkpoint_dir = "/home/user/data/gsj/111111111/my_cnn_model/BaseModel_ADHD/"
        best_model_dir = "/home/user/data/gsj/111111111/my_cnn_model/Bset_BaseModel_ADHD/"
        best_model_path = ""
        test_accuracy1 = 0
        test_ave = 0
